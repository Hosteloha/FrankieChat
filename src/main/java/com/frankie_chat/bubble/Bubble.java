package com.frankie_chat.bubble;
 ...
 * @version 1
 *
 *          Library for creating nice chatbubbles in JavaFX Copyright zeppel
 *          2019
 *
 *          Requirements: JavaFX
 *
...
public class Bubble extends Group {
	...
	private Paint textColor = Color.rgb(44, 62, 80);
	private Font metaFont = Font.font("Consolas", 8);
	private Paint metaColor = Color.rgb(127, 140, 141);
	...
	private Paint bubbleColor = Color.rgb(236, 240, 241);

	private int edgeRadius = 10;
